...
LIGHT_BLUE = "#CCEDFF"
LIGHT_GREY = "#F5F5F5" 
LABEL_COLOR = "#25265E" #buttons color 
...
class Calculator:
    ...
    def create_display_labels(self):
        ...
        label = tk.Label(self.display_frame, text=self.current_expression, anchor=tk.E, bg=LIGHT_GREY, fg=LABEL_COLOR,
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=OFF_WHITE, fg=LABEL_COLOR,
                                font=DEFAULT_FONT_STYLE, border=0, command=self.clear)
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=OFF_WHITE, fg=LABEL_COLOR,
                                font=DEFAULT_FONT_STYLE, border=0, command=self.square)
    ...
    def create_sqrt_button(self):
        button = tk.Button(self.buttons_frame, text="\u221ax", bg=OFF_WHITE, fg=LABEL_COLOR,
                                font=DEFAULT_FONT_STYLE, border=0, command=self.sqrt)
